...
CREATE TABLE `phan_quyen` (
  ...
  KEY `ID_BP` (`ID_BP`),
  CONSTRAINT `phan_quyen_ibfk_1` FOREIGN KEY (`ID_NQ`) REFERENCES `nhom_quyen` (`ID_NQ`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `phan_quyen_ibfk_2` FOREIGN KEY (`ID_BP`) REFERENCES `bo_phan` (`ID_BP`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
